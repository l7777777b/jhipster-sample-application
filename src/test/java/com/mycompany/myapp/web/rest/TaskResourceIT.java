...
public class TaskResourceIT {
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getTaskMode()).isEqualTo(DEFAULT_TASK_MODE);
        assertThat(testTask.getValue()).isEqualTo(DEFAULT_VALUE);
    }
    ...
    public void updateTask() throws Exception {
        ...
        Task testTask = taskList.get(taskList.size() - 1);
        assertThat(testTask.getTaskMode()).isEqualTo(UPDATED_TASK_MODE);
        assertThat(testTask.getValue()).isEqualTo(UPDATED_VALUE);
    }
